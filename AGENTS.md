...
Sequences are defined at module level in `SEQUENCES`:

```python
SEQUENCES = {
    "school":      {"days": [1, 3, 5, 7, 10], "template_prefix": "SCHOOL EMAIL ", ...},
    "csr":         {"days": [1, 3, 5, 7, 10], "template_prefix": "CSR EMAIL ",    ...},
...
*Last updated by an AI coding agent after codebase exploration on 2026-06-03. Keep this file in sync with structural or workflow changes.*
