...
if old_template in engine:
    engine = engine.replace(old_template, new_template)
    with open(engine_path, "w", encoding="utf-8") as f:
        f.write(engine)
    print("✅ engine.py: HTML_TEMPLATE fixed")
else:
    print("⚠️ engine.py: HTML_TEMPLATE not found (may already be fixed)")
...
print("\n🎉 Done! Now commit and push via GitHub Desktop.")
